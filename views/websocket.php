            ...
            <div class="col-md-8">
                <div class="p-2 bg-white rounded shadow-sm mb-2">
                    ...
                    <form action="#" method="post" id="login-ssh">
                        ...
                        <?php if(isset($_SESSION['auth'])): ?>
                            <button type="button" disabled class="btn btn-primary btn-sm w-100 subb">Muy pronto</button>
                        <?php else: ?>
                            <a href="?content=login" class="btn btn-primary btn-sm w-100 subb">Muy pronto</a>
                        <?php endif ?>
                    </form>
                </div>
            </div>
